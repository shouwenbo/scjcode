...
namespace JJBSelfCheckApp
{
    public class Member
    {
        ...
        public List<string> Check()
        {
            ...
            else if (!KoreanName.IsAllKorean())
            {
            ...
            if (Gender!= "남" && Gender!= "녀") // 410607更新 여 改为 녀
            {
    ...
    public class FamilyMemberInfo
    {
        ...
        public List<string> Check(string bysFirstName, string bysGender, bool bysIsMarry)
        {
            ...
            if (!string.IsNullOrEmpty(Birthday) && !Birthday.IsValidyyyyMMddDate(out DateTime birth))
            {
                Birth = birth;
            ...
            if (BirthChurch.Length > 0 && BirthChurch.Length < 2)
            {
                result.Add($"家属:{Name} -> 出席教会::{BirthChurch} 字数太少");
            }
            else if (BirthChurch.Length > 4)
            {
                var churchNameMsg = $"家属:{Name} -> 出席教会::{BirthChurch} 字数太长";
                if (BirthChurch.Contains("三自教会"))
                {
                    churchNameMsg += " 建议去掉'三自教会'";
                }
                if (BirthChurch.Contains("基督教会"))
                {
                    churchNameMsg += " 建议去掉'基督教会'";
                }
                else if (BirthChurch.Contains("基督教堂"))
                {
                    churchNameMsg += " 建议去掉'基督教堂'";
                }
                else if (BirthChurch.Contains("基督教"))
                {
                    churchNameMsg += " 建议去掉'基督教'";
                }
                else if (BirthChurch.Contains("教会"))
                {
                    churchNameMsg += " 建议去掉'教会'";
                }
                else if (BirthChurch.Contains("教堂"))
                {
                    churchNameMsg += " 建议去掉'教堂'";
                }
                result.Add(churchNameMsg);
            ...
            else
            {
                if (BirthChurch.Contains("基督教会"))
                {
                    result.Add($"家属:{Name} -> 出席教会::{BirthChurch} 建议去掉'基督教会");
                }
                else if (BirthChurch.Contains("基督教堂"))
                {
                    result.Add($"家属:{Name} -> 出席教会::{BirthChurch} 建议去掉'基督教堂");
                }
                else if (BirthChurch.Contains("基督教"))
                {
                    result.Add($"家属:{Name} -> 出席教会::{BirthChurch} 建议去掉'基督教");
                }
                else if (BirthChurch.Contains("教会"))
                {
                    result.Add($"家属:{Name} -> 出席教会::{BirthChurch} 建议去掉'教会");
                }
                else if (BirthChurch.Contains("教堂"))
                {
                    result.Add($"家属:{Name} -> 出席教会::{BirthChurch} 建议去掉'教堂");
                }
            }
            ...
            if (BirthChurch == "중국무한")
            {
                ...
                {
                    result.Add($"家属:{Name} -> 出席教会:{Religion} 工号格式错误");
                }
            }
            else
            {
